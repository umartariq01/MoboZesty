...
describe('My Login application', () => {
    it('should login with valid credentials', async () => {
        ...
        const short_pass                = 'QWS';
        const expected_short_pass_error = 'Your password must be 8 or more characters long, and include at least 1 uppercase letter, 1 lowercase letter, and 1 number';
        const expected_pass_mismatch    = 'Passwords must match. Please try again';
